...
?>
    ...
    <?php if ( get_row_layout() == 'two_column_fixed' ) : ?>
        <?php include locate_template( 'template-blocks/block-two-column-fixed.php' ); ?>
    <?php endif; ?>

    <?php if ( get_row_layout() == 'digital-solutions-block' ) : ?>
        <?php include locate_template( 'template-blocks/block-digital-solutions.php' ); ?>
    <?php endif; ?>

    <?php if ( get_row_layout() == 'single_testimonial' ) : ?>
        <?php include locate_template( 'template-blocks/block-single-testimonial.php' ); ?>
    <?php endif; ?> 
