                            ...
                            <?php if (!get_sub_field('button_text')) : ?>
                                <?php if (!is_page(array('seo-audit', 'google-ads-audit', 'competitor-audit', 'facebook-interest-finder', 'seo-roi-calculator', 'ppc-roi-calculator'))) : ?>
                                    ...
                                    <?php if (ICL_LANGUAGE_CODE == "zh") : ?>
                                        <button type="button" class="btn fp-btn fp-btn-orange showpopup" data-tippy-interactive="true" data-tippy-theme="dark" data-tippy-placement="bottom" data-tippy-html="#pop-up-form" data-tippy-trigger="click">索取免費報價</button>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
