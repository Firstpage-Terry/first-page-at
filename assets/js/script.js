...
$(function () {
  ...
  window.Parsley.addValidator("websiteCheck", {
    validateString: function (value) {
      ...
      if (
        value.indexOf("firstpage") !== -1 ||
        value.indexOf("appscore.au") !== -1 ||
        value.indexOf("removify.au") !== -1
      ) {
        return false;
      } else {
        return true;
  ...
  $(document).on("click", 'form.fp-form button[type="submit"]', function () {
    ...
    var formlocation = $(this).data("formlocation");
  ...
  let secondCollapses = $("#second-accordion .collapse");
  let secondSigns = $("#second-accordion .accordion-sign");

  $("#second-accordion .card").on("click", function () {
    secondCollapses.slideUp();
    secondSigns.html("+");
