    ...
    $(document).on("click", 'form.fp-form button[type="submit"]', function () {
      ...
      if ($form.length > 0) {
        ...
        if ($form.parsley().isValid()) {
          ...
          // Send Ajax
          $.ajax({
            url: "https://www.firstpage.hk/action/hubspot/submit.php",
            type: "post",
            dataType: "json",
            ...
            success: function (data) {
              ...
              if (!!$form.attr("action")) {
                ...
                if (theLang === 'en-US') {
                  ...
                  window.location.replace("/zh/thank-you");
                }
    ...
    if ($("#new-session-form").length > 0) {
      $("#new-session-form")
        ...
        .on("form:submit", function () {
          ...
          var wpSiteUrl = "https://www.firstpage.hk";
          // Add Spinner
          $this
