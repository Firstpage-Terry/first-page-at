...
function showTab(n) {
  ...
  if (n == x.length - 1) {
    if (theLang === 'en-US') {
      document.getElementById("nextBtn").innerHTML = "GET YOUR FREE STRATEGY";
    } else if (theLang === 'zh-HK') {
      document.getElementById("nextBtn").innerHTML = "獲取您的免費策略";
    }
  } else {
    if (theLang === 'en-US') {
      document.getElementById("nextBtn").innerHTML = "GET YOUR FREE STRATEGY";
...
function nextPrev(n) {
  ...
  if (currentTab >= x.length) {
    ...
    if (theLang === 'en-US') {
      ...
      $("#strategyForm").attr("action", "/zh/thank-you");
    }
