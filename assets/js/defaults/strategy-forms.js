...
function showTab(n) {
  ...
  if (n == x.length - 1) {
    ...
    } else if (theLang === 'zh-HK') {
      document.getElementById("nextBtn").innerHTML = "返回首頁";
    }
...
function nextPrev(n) {
  ...
  if (currentTab == 2) {
    ...
    window.dataLayer.push({
      ...
      user_name: sha256($("[name='firstname']").val()),
      user_phone: sha256($("[name='lead_phone']").val()),
      user_email: sha256($("[name='email']").val())
  ...
  switch (currentTab) {
    case 0:
      if (theLang === 'en-US') {
        ...
        reviewText = "他們的數碼營銷服務助我成功達到業務目標，我尤其要感謝Isaac。";
      }
      reviewPerson = "THE TIMELESS COMPANY";
      break;
    case 1:
      if (theLang === 'en-US') {
        reviewText = "We had a 300% increase in leads. These guys really know their stuff.";
      } else if (theLang === 'zh-HK') {
        reviewText = "Chinese content here";
      }
      reviewPerson = "JOHN ROBINSON";
      break;
    case 2:
      reviewText = 'All I can say is "wow". Completely blown away by the speed and execution of First Page.';
      reviewPerson = "NICK BARLETT";
      break;
    case 3:
      reviewText = "They are very supportive and professional. They think in your shoes and work with you to achieve a great outcome.";
      reviewPerson = "CHARLIE LAU";
      break;
    case 4:
      reviewText = "A creative team of geniuses. This is your one stop shop for all things digital.";
      reviewPerson = "CRAIG ROBISON";
      break;
    case 5:
      reviewText = "The response times and the results have been fantastic and we would definitely recommend First Page services!";
      reviewPerson = "RICH OLIVER";
      break;
    case 6:
      reviewText = "Thank you! I truly appreciate your guidance and knowledge. Great communication and great service!";
      reviewPerson = "DES BROOKES";
      break;
    case 7:
      reviewText = "Team of wonderful people that really care and work hard to deliver great results. We are proud of our partnership.";
...
function validateWebsite(website) {
  ...
  if (website.trim().length != 0 || pattern.test(website) && website != "") {
    return true;
  } else {
    return false;
  }
