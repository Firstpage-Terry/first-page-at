...
function firstpage_scripts() {
    ...
    wp_enqueue_style( 'firstpage-style',  get_template_directory_uri() . '/assets/css/style.css?time=' . filemtime(get_stylesheet_directory() . "/assets/css/style.css") );
    
    // js
	wp_enqueue_script( 'firstpage-navigation', get_template_directory_uri() . '/assets/js/defaults/navigation.js', array(), '20151215', true );
    wp_enqueue_script( 'firstpage-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/defaults/skip-link-focus-fix.js', array(), '20151215', true );
    ...
    wp_enqueue_script( 'firstpage-mainJS',  get_template_directory_uri() . '/assets/js/main.js?time=' . filemtime(get_stylesheet_directory() . "/assets/js/main.js"), array(), null, true );
