...
<?php // $form_button = ((empty($form_button)) ? ('Get Your Free Ebook') : ($form_button)); ?>
<?php $form_hs = ((empty($form_hs)) ? ('hs_amazon_ebook_form') : ($form_hs)); ?>
<?php $form_thankyou = ((empty($form_thankyou)) ? ('ebook') : ($form_thankyou)); ?>
...
<div class="quote-form quote-form-big pt-0">
	...
	<?php if (ICL_LANGUAGE_CODE == "en") : ?>
		<form class="fp-form" action="<?php echo get_home_url(); ?>/ebook/" method="POST">
			<div class="form-step-1 form-step">
            <span class="h3">When are you selling on Amazon?</span>
				<div class="input-group">
                    <div class="select-container form-control">
							<select class="form-control" name="lead_amazon_interest">
					...
					<div class="input-group-btn">
						<button type="button" class="btn fp-btn fp-btn-orange form-continue">SUBMIT</button>
					</div>
				</div>
			</div>
			<div class="form-step-2 form-step">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<button type="submit" data-title="Main Banner Get A Free Quote" class="form-control btn fp-btn fp-btn-orange buttonFormClick">Get Your Free Ebook</button>
					</div>
				</div>
			</div>
