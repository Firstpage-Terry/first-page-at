<?php get_header(); ?>
	...
	<section class="section-background text-center py-5">
		<div class="container container-single-image">
			<img src="/wp-content/themes/firstpage/assets/img/who_we_are_group_md_new_update.png" class="img-fluid d-none d-md-block d-lg-none mx-auto" alt="First Page"/>
			<img src="/wp-content/themes/firstpage/assets/img/who_we_are_group_lg_new_update.png" class="img-fluid d-none d-lg-block mt-5 mx-auto" alt="First Page"/>
		</div>
		<img src="/wp-content/themes/firstpage/assets/img/who_we_are_group_sm_new_update.png" class="img-fluid d-md-none mt-5" alt="First Page"/>
	</section>
<?php get_footer();