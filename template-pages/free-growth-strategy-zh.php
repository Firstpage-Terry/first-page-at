...
<?php
/**
 * Template Name: Free Growth Strategy Chinese
 *
...
<head>
    ...
    <link rel="stylesheet" href="/wp-content/themes/firstpage/css/strategy-forms.css"/>
    ...
    <script type="text/javascript"
            ...
            async
            defer
            src="//js.hs-scripts.com/9300456.js"></script>
...
<!-- End Google Tag Manager -->
    ...
    <meta name="description"
          content="Claim your 100% FREE 30-minute GROWTH strategy session. We've got your bulletproof tactics, proven to increase website traffic and revenue." />
    <title>取得30分鐘免費的營銷策略諮詢</title>
</head>
...
<!-- End Google Tag Manager (noscript) -->
    <div class="container mt-3 mt-sm-5 strategy-form-container">
                        ...
                        <g id="Startegy-Session-Form---Step-1"
                           ...
                           stroke-width="3">
                            <g id="Group"
                               transform="translate(47.000000, 28.000000)">
                                <polyline id="back"
                                          points="18.5038671 7 0.503867057 20 18.5038671 33"></polyline>
                            </g>
                        </g>
                    </g>
                </svg>
                <span class="strategy-form-back-btn">上一步</span>
            </div>

            <div class="sf-cross-holder"
                 id="sf-cross-holder">
                <a href="/"><i class="fas fa-times fa-lg"></i></a>
            </div>
        </div>
        <!-- Progress Bar -->
        <div class="progress strategy-form-progress d-none"
             id="sf-progress-bar">
            <div class="progress-bar strategy-form-progress-bar"
        ...
        <form id="strategyForm"
              action="https://www.firstpage.hk/action/hubspot/strategyFormSubmitHandler.php"
              method="POST"
              class="strategy-form">
            <!-- One "tab" for each step in the form: -->
            <div class="tab tab-one">
                <div class="strategy-form-hero-text">取得30分鐘免費的營銷策略諮詢</div>
                <div class="strategy-form-main-text">
                    <p>我們會向你講解各種高效的營銷策略，助你大幅提升網站流量及營業額。</p>
                    <p class="strategy-form-input-holder my-sm-5">
                        <input class="strategy-form-input-field"
                               placeholder="網址"
                               name="website"
                               type="text"
                               id="sf-website" />
                ...
                <div class="strategy-form-main-text">
                    ...
                    <p class="strategy-form-input-holder">
                        <input class="strategy-form-input-field"
                               ...
                               type="text"
                               id="sf-firstname" />
                        <span class="sfErrorMessage"
                              id="nameErrorMsg"
                              style="display: none">請輸入有效的名字</span>
                    </p>
                    <p class="strategy-form-input-holder">
                        <input class="strategy-form-input-field"
                               placeholder="電郵*"
                        ...
                        <span class="sfErrorMessage"
                              id="emailErrorMsg"
                              style="display: none">請輸入有效的電郵地址</span>
                    </p>
                    ...
                    <p class="strategy-form-input-holder">
                        ...
                        <span class="sfErrorMessage"
                              id="phoneErrorMsg"
                              style="display: none">請輸入有效的電話號碼</span>
                    </p>
                </div>
            </div>
            <!-- Tab Three -->
            <div class="tab marketing-type-tab">
                <div class="strategy-form-hero-text">你的企業正在採用哪一種營銷策略？</div>
                <div class="strategy-form-main-text">
                    <p>可選取多於一種選項</p>
                </div>
                <div class="row form-selector-row">
                    ...
                    <div class="col-4 col-sm-3">
                        <div class="marketing-type-selector-container">
                            <label for="seo-checkbox"
                                   class="icon-label">
                                <img class="select-icon"
                                     src="/wp-content/themes/firstpage/assets/img/search.svg"
                                     alt="" />
                                <input type="checkbox"
                                       name="marketing_seo"
                                       value="Marketing SEO (Selected Marketing Type)"
                                       id="seo-checkbox"
                    ...
                    <div class="col-4 col-sm-3">
                        <div class="marketing-type-selector-container">
                            <label for="google-ads-checkbox"
                                   class="icon-label">
                                <img class="select-icon"
                                     src="/wp-content/themes/firstpage/assets/img/adwords.svg"
                                     alt="" />
                                <input type="checkbox"
                                       name="marketing_google_ads"
                                       value="Google Ads (Selected Marketing Type)"
                                       id="google-ads-checkbox"
                                       class="select-checkbox" />
                                <div class="select-checkbox-bg"></div>
                            </label>
                        </div>
                        <p class="marketing-type-text googleAds-selector-text">Google 廣告</p>
                    </div>
                    <!-- Facebook -->
                    <div class="col-4 col-sm-3">
                        <div class="marketing-type-selector-container">
                            <label for="facebook-checkbox"
                                   class="icon-label">
                                <img class="select-icon"
                                     src="/wp-content/themes/firstpage/assets/img/facebook.svg"
                                     alt="" />
                                <input type="checkbox"
                                       name="marketing_facebook"
                                       value="Facebook (Selected Marketing Type)"
                    ...
                    <div class="col-4 col-sm-3">
                        <div class="marketing-type-selector-container">
                            <label for="print-checkbox"
                                   class="icon-label">
                                <img class="select-icon"
                                     src="/wp-content/themes/firstpage/assets/img/print.svg"
                                     alt="" />
                                <input type="checkbox"
                                       name="marketing_print"
                                       value="Print (Selected Marketing Type)"
                                       id="print-checkbox"
                                       class="select-checkbox" />
                                <div class="select-checkbox-bg"></div>
                            </label>
                        </div>
                        <p class="marketing-type-text print-selector-text">報章雜誌</p>
                    </div>

                    <!-- Affiliate -->
                    <div class="col-4 col-sm-3">
                        <div class="marketing-type-selector-container">
                            <label for="affiliate-checkbox"
                                   class="icon-label">
                                <img class="select-icon"
                                     src="/wp-content/themes/firstpage/assets/img/affiliate.svg"
                                     alt="" />
                                <input type="checkbox"
                                       name="marketing_affiliate"
                                       value="Affiliate (Selected Marketing Type)"
                                       id="affiliate-checkbox"
                                       class="select-checkbox" />
                                <div class="select-checkbox-bg"></div>
                            </label>
                        </div>
                        <p class="marketing-type-text affiliate-selector-text">聯盟行銷</p>
                    </div>
                    <!-- TV -->
                    <div class="col-4 col-sm-3">
                        <div class="marketing-type-selector-container">
                            <label for="tv-checkbox"
                                   class="icon-label">
                                <img class="select-icon"
                                     src="/wp-content/themes/firstpage/assets/img/tv.svg"
                                     alt="" />
                                <input type="checkbox"
                                       name="marketing_tv"
                                       value="TV (Selected Marketing Type)"
                                       id="tv-checkbox"
                                       class="select-checkbox" />
                                <div class="select-checkbox-bg"></div>
                            </label>
                        </div>
                        <p class="marketing-type-text tv-selector-text">電視</p>
                    </div>
                    <!-- Radio -->
                    <div class="col-4 col-sm-3">
                        <div class="marketing-type-selector-container">
                            <label for="radio-checkbox"
                                   class="icon-label">
                                <img class="select-icon"
                                     src="/wp-content/themes/firstpage/assets/img/radio.svg"
                                     alt="" />
                                <input type="checkbox"
                                       name="marketing_radio"
                                       value="Radio (Selected Marketing Type)"
                                       id="radio-checkbox"
                                       class="select-checkbox" />
                                <div class="select-checkbox-bg"></div>
                            </label>
                        </div>
                        <p class="marketing-type-text radio-selector-text">電台</p>
                    </div>
                    <!-- None -->
                    <div class="col-4 col-sm-3">
                        <div class="marketing-type-selector-container">
                            <label for="none-checkbox"
                                   class="icon-label">
                                <img class="select-icon"
                                     src="/wp-content/themes/firstpage/assets/img/none.svg"
                                     alt="" />
                                <input type="checkbox"
                                       name="marketing_none"
                                       value="None (Selected Marketing Type)"
                                       id="none-checkbox"
                                       class="select-checkbox" />
                                <div class="select-checkbox-bg"></div>
                            </label>
                        </div>
                        <p class="marketing-type-text none-selector-text">沒有</p>
                    </div>
                </div>
            </div>
            <!-- Tab Four -->
            <div class="tab">
                <div class="strategy-form-hero-text business-type-tab">What best describes your business?</div>
            ...
            <div class="tab pain-point-tab">
                <div class="strategy-form-hero-text">你的企業目前正面對哪種主要問題？</div>
                <div class="tab-four-input-container">
                    <!-- pain point row one -->
                    <div class="row mt-4">
                        <div class="col-1 col-md-2"></div>
                        <div class="col-5 col-md-4 strategy-form-radio-container">
                            <div class="custom-form-check">
                                <label class="custom-radio-container">
                                    ...
                                    <input type="radio"
                                           name="pain_point"
                                           value="I need more traffic to my website" />
                                    <span class="custom-radio"></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="col-5 col-md-4 strategy-form-radio-container">
                            <div class="custom-form-check">
                                <label class="custom-radio-container">
                                    ...
                                    <input type="radio"
                                           name="pain_point"
                                           value="I need help converting traffic into opportunities" />
                                    <span class="custom-radio"></span>
                                </label>
                            </div>
                        </div>
                        <div class="col-5 col-md-4 strategy-form-radio-container">
                            <div class="custom-form-check">
                                <label class="custom-radio-container">
                                    ...
                                    <input type="radio"
                                           name="pain_point"
                                           value="I need help with brand awareness" />
                                    <span class="custom-radio"></span>
                                </label>
                            </div>
                        </div>
            ...
            <div class="tab budget-tab">
                <div class="strategy-form-hero-text">你每月的數碼營銷預算為？</div>
            ...
            <div class="tab when-start-tab">
                <div class="strategy-form-hero-text">你希望何時開始落實數碼營銷策略？</div>
            ...
            <div class="tab promise-tab">
                <div class="strategy-form-hero-text">恭喜你成功獲得30分鐘免費營銷策略諮詢！</div>
                <div class="strategy-form-main-text">
                    <p>我們將會在今日稍後時間聯絡你。</p>
                </div>
            </div>
            ...
            <div class="strategy-form-btn-holder">
                ...
                <input type="hidden"
                       name="lead_formtype"
                       value="hs_strategy_form" />
                <button type="button"
                        id="nextBtn"
                        class="strategy-form-next-btn"
                        onclick="nextPrev(1)">獲取您的免費策略</button>
                        <span class="sfErrorMessage"
                        id="webErrorMsg"
                        style="display: none; text-align: center; margin-top: 15px; color: rgb(102, 102, 102);">沒有網站？沒問題。輸入”沒有網站“。</span>
            </div>
            <!-- Testimonial -->
                    ...
                    <div class="row testimonial-cont">
                        <div class="col-12">
                            <div class="testimonial">
                                <div class="stars">
                                    <img src="/wp-content/themes/firstpage/assets/img/icon-star.png"
                                         srcset="/wp-content/themes/firstpage/assets/img/icon-star@2x.png 2x"
                                         alt="Five Stars" />
                                    <img src="/wp-content/themes/firstpage/assets/img/icon-star.png"
                                         srcset="/wp-content/themes/firstpage/assets/img/icon-star@2x.png 2x"
                                         alt="Five Stars" />
                                ...
                                <div class="text"
                                     ...
                                     id="sf-review-text">他們的數碼營銷服務助我成功達到業務目標，我尤其要感謝Isaac。</div>
                                <div class="person">
                                    <div class="name"
                                         id="sf-review-person">THE TIMELESS COMPANY</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- core js -->
    <script type="text/javascript" src="/wp-content/themes/firstpage/assets/js/defaults/strategy-forms.js"></script>
    <!-- hashing js -->
