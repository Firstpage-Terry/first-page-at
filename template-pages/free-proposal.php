...
<head>
    ...
    <!-- Site CSS -->
    <link rel="stylesheet"
          href="/wp-content/themes/firstpage/assets/css/style.css" />
    ...
    <meta name="description"
          content="See how we can get you massive amounts of traffic, leads and sales 🔥 Get your free custom strategy from the #1 SEO company in Australia!">
...
<body class="strategy-form-body">
            ...
            <form id="strategyForm"
                ...
                <div class="tab tab-one">
                    <div class="strategy-form-hero-text">
                        <h1>Build a kick-ass brand &amp; <span style="color:#ff5254;">skyrocket</span> your revenue. <br
                                class="d-none d-lg-block"> Get your free custom strategy.</h1>
                        <p class="h4 marketing-ideas">Get 11+ killer <span style="color:#ff5254;">marketing ideas</span>
                            that will destroy your competition.</p>
                    </div>
                    ...
                    <div class="strategy-form-main-text">
                        <p class="strategy-form-input-holder">
                            ...
                            <span class="sfErrorMessage"
                                id="nameErrorMsg"
                                style="display: none;">Please enter a valid name</span>
                        </p>
                        <p class="strategy-form-input-holder">
                            <input class="strategy-form-input-field"
                                placeholder="Email*"
                        ...
                        <p class="strategy-form-input-holder">
                            ...
                            <span class="sfErrorMessage"
                                id="phoneErrorMsg"
                                style="display: none;">Please enter a valid phone number</span>
                        </p>
                ...
                <div class="strategy-form-btn-holder">
                    ...
                    <span class="sfErrorMessage"
                                id="webErrorMsg"
                                style="display: none; text-align: center; margin-top: 15px; color: rgb(102, 102, 102);">No website? No problem. Just say "no site".</span>
                </div>
                <!-- Testimonial -->
                            ...
                            <div class="col-12">
                                <div class="testimonial">
                                    ...
                                    <div class="text"
                                        ...
                                        id="sf-review-text">
                                        They smashed our business goals and a special thanks to Isaac for driving the
                                        digital campaign.
                                    </div>
                                    <div class="person">
                                        <div class="name"
    ...
    <!-- core js -->
    <script type="text/javascript" src="/wp-content/themes/firstpage/assets/js/defaults/strategy-form-free-proposal.js"></script>
    <!-- hashing js -->
