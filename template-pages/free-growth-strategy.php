...
<!-- End Google Tag Manager -->
    ...
    <noscript><img height="1" width="1" style="display:none" src="https://www.facebook.com/tr?id=626312374449025&ev=PageView&noscript=1"/></noscript>
...
<div class="container mt-3 mt-sm-5 strategy-form-container">
    ...
    <form id="strategyForm" action="https://www.firstpage.hk/action/hubspot/strategyFormSubmitHandler.php" method="POST" class="strategy-form">
                ...
                <div class="col-4 col-sm-3">
                    <div class="marketing-type-selector-container">
                        <label for="seo-checkbox" class="icon-label">
                            <img class="select-icon" src="/wp-content/themes/firstpage/assets/img/search.svg" alt="">
                ...
                <div class="col-4 col-sm-3">
                    <div class="marketing-type-selector-container">
                        <label for="google-ads-checkbox" class="icon-label">
                            <img class="select-icon" src="/wp-content/themes/firstpage/assets/img/adwords.svg" alt="">
                ...
                <div class="col-4 col-sm-3">
                    <div class="marketing-type-selector-container">
                        <label for="facebook-checkbox" class="icon-label">
                            <img class="select-icon" src="/wp-content/themes/firstpage/assets/img/facebook.svg" alt="">
                ...
                <div class="col-4 col-sm-3">
                    <div class="marketing-type-selector-container">
                        <label for="print-checkbox" class="icon-label">
                            <img class="select-icon" src="/wp-content/themes/firstpage/assets/img/print.svg" alt="">
                ...
                <div class="col-4 col-sm-3">
                    <div class="marketing-type-selector-container">
                        <label for="affiliate-checkbox" class="icon-label">
                            <img class="select-icon" src="/wp-content/themes/firstpage/assets/img/affiliate.svg" alt="">
                ...
                <div class="col-4 col-sm-3">
                    <div class="marketing-type-selector-container">
                        <label for="tv-checkbox" class="icon-label">
                            <img class="select-icon" src="/wp-content/themes/firstpage/assets/img/tv.svg" alt="">
                ...
                <div class="col-4 col-sm-3">
                    <div class="marketing-type-selector-container">
                        <label for="radio-checkbox" class="icon-label">
                            <img class="select-icon" src="/wp-content/themes/firstpage/assets/img/radio.svg" alt="">
                ...
                <div class="col-4 col-sm-3">
                    <div class="marketing-type-selector-container">
                        <label for="none-checkbox" class="icon-label">
                            <img class="select-icon" src="/wp-content/themes/firstpage/assets/img/none.svg" alt="">
                        ...
                        <div class="testimonial">
                            <div class="stars">
                                <img src="/wp-content/themes/firstpage/assets/img/icon-star.png"
                                     srcset="/wp-content/themes/firstpage/assets/img/icon-star@2x.png 2x" alt="Five Stars">
                                <img src="/wp-content/themes/firstpage/assets/img/icon-star.png"
                                     srcset="/wp-content/themes/firstpage/assets/img/icon-star@2x.png 2x" alt="Five Stars">
                                <img src="/wp-content/themes/firstpage/assets/img/icon-star.png"
                                     srcset="/wp-content/themes/firstpage/assets/img/icon-star@2x.png 2x" alt="Five Stars">
